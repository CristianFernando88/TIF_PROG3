    ...
    return(
        <div key={step.order} className="columns">
            ...
            <div className="column field is-grouped">
                <div className="control">
                    <button className="button is-success" onClick={()=>setOpenModalEdit(true)}>Editar</button>
                </div>
                <div className="control">
                    <button className="button is-danger" onClick={()=>setOpenModal(true)}>Eliminar</button>
                </div>
            </div> 
